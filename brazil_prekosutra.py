...
OUT_TXT = Path("brazil_prekosutra_sledeci_mecevi.txt")        # RAW (samo PREKOSUTRA)
OUT_PRETTY = Path("brazil_prekosutra_mecevi_pregled.txt") # Sređen pregled (samo PREKOSUTRA)
